...
export function ConfirmacionCita({ clientName, service, date, time, price, isFirstVisit }: Props) {
  return (
    <Html lang="es">
      <Head>
        <Font
      ...
      <Preview>Tu cita está confirmada — {service} el {date}</Preview>
      <Body style={body}>
        ...
        <Container style={card}>
          ...
          <Section style={cardBody}>
            ...
            <Text style={intro}>
              Hola <strong style={{ color: '#2D3220' }}>{clientName}</strong>, aquí están los detalles de tu cita.
            </Text>
            ...
            {isFirstVisit && (
              <div style={firstVisitBox}>
                <Text style={firstVisitText}>
                  🌿 <strong>Primera visita:</strong> Por favor llega <strong>15 minutos antes</strong> para completar tu ficha de análisis de piel.
                </Text>
              </div>
            )}
