  ...
  return (
    <aside className="w-52 bg-olive-dark min-h-screen flex flex-col shrink-0">
      ...
      <div className="px-5 pt-6 pb-5 border-b border-white/10">
        <div className="font-script text-4xl text-white/90 leading-none mb-1">Angelin</div>
        <div className="text-white/40 text-xs tracking-wide">Esthetician Studio</div>
      </div>
      ...
      <div className="px-4 py-4 border-t border-white/10">
        ...
        >
          ...
          <span className="text-white/55 text-xs group-hover:text-white/90 transition-colors">Angelin</span>
        </button>
      </div>
    </aside>
  )
